...
public class SimpleShoot : MonoBehaviour
{
    ...
    {
        //if(hasSlide)
       // OVRInput.Update();&& (OVRInput.Get(OVRInput.RawAxis1D.RIndexTrigger) >= 0.5f)
       // OVRInput.Update();
    ...
    void Shoot()
    {
       ...
       // Instantiate(bulletPrefab, barrelLocation.position, barrelLocation.rotation).GetComponent<Rigidbody>().AddForce(barrelLocation.forward * shotPower);
         Instantiate(bulletPrefab, barrelLocation.position, barrelLocation.rotation).GetComponent<Rigidbody>().AddForce(barrelLocation.forward * 5000f);
